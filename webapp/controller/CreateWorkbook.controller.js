sap.ui.define([
	...
	return BaseController.extend("com.lbrands.assortments.controller.CreateWorkbook", {
		...
		onInit: function() {
			var that = this;
			this.getRouter().getTargets().getTarget("createWorkbook").attachDisplay(null, this._onDisplay, this);
		...
		onTemplateSelect: function(oEvent) {
			...
			oModel.setProperty('TemplateID', value, this.getView().getBindingContext());
		},

		onCategorySelect: function(oEvent) {
			var oModel = this.getModel(),
				value = oEvent.getParameter('selectedItem').getKey();
			oModel.setProperty('CategoryID', value, this.getView().getBindingContext());
		},

		onEmotionalSpaceSelect: function(oEvent) {
			var oModel = this.getModel(),
				value = oEvent.getParameter('selectedItem').getKey();
			oModel.setProperty('EmotionalSpaceID', value, this.getView().getBindingContext());
		},
		...
		_navBack: function() {
			...
			if (sPreviousHash !== undefined) {
				...
				this.getRouter().getTargets().display("workbook");
			}
		},
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Workbooks", {
				properties: {
					"ID": 1
				},
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("Workbooks", oData);
		...
		/*onWorkbookSelect: function(oEvent){
