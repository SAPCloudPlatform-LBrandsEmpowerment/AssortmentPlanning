...
sap.ui.define([
	...
	"sap/m/MessageBox",
	"com/lbrands/assortments/model/grouper",
	...
	return BaseController.extend("com.lbrands.assortments.controller.Master", {
		...
		onInit: function() {
			...
			var imagePath = jQuery.sap.getModulePath('com.lbrands.assortments.images') + '/person.png';
			this.getView().byId("idProfilePhoto").setSrc(imagePath);
		},
		...
		onOpenViewSettings: function() {
			if (!this._oViewSettingsDialog) {
				this._oViewSettingsDialog = sap.ui.xmlfragment("com.lbrands.assortments.view.ViewSettingsDialog", this);
		...
		_onMasterMatched: function() {
			this._oListSelector.oWhenListLoadingIsDone.then(
				function(mParams) {
					...
					mParams.firstListitem.setSelected(true);
		...
		_showDetail: function(oItem) {
			...
			if(oItem.getTitle() === 'Workbooks'){
				this.getRouter().getTargets().display("workbook");
			}else if(oItem.getTitle() === 'Templates'){
				this.getRouter().getTargets().display("template");
			}
			
			

			this.getRouter().navTo("object", {
				artifactId: oItem.getTitle()
			}, bReplace);
