sap.ui.define([
	...
	function getFrameUrl(sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/lbrands/assortments/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#AssortmentPlanning-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#AssortmentPlanning-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("com.lbrands.assortments.test.integration.pages.Common", {
		...
		getMockServer: function() {
			return new Promise(function(success) {
				Opa5.getWindow().sap.ui.require(["com/lbrands/assortments/localService/mockserver"], function(mockserver) {
